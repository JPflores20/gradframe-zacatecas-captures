...
// Generamos la URL dinámicamente usando la constante
const WHATSAPP_URL = `https://wa.me/${CONTACT_WHATSAPP_NUMBER}?text=Hola%2C%20quisiera%20recibir%20m%C3%A1s%20informaci%C3%B3n%20sobre%20sus%20paquetes`;
