            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                {titlePhotos.map((item) => (
                  <div key={item.label} className="flex items-center justify-between rounded-md bg-secondary px-4 py-3">
        ...
        >
          <Card className="h-full border bg-card">
            <CardContent className="flex h-full flex-col items-start justify-center p-6">
              ...
              <span className="mt-4 font-serif text-3xl font-bold text-foreground">$320</span>
